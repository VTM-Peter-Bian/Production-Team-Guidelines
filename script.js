...
(function () {
  ...
  const DEV_ENV_GRAPH = {
    ...
    links: [
      ...
      { source: "data-mgmt", target: "aws-web", lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.22 } },
      { source: "aws-web", target: "aws-db", lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.22 } },
      { source: "data-mgmt", target: "aws-s3", lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.22 } },
      ...
      { source: "src-code", target: "smart-svn", lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.22 } },
      { source: "smart-svn", target: "svn", lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.22 } },
      ...
      { source: "meta-quest", target: "openxr", lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.32, curveness: 0.45 } },
      { source: "pico", target: "openxr", lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.32, curveness: 0.2 } },
      { source: "htc", target: "openxr", lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.32, curveness: -0.35 } },
      { source: "android", target: "api-std" },
      { source: "api-std", target: "openxr" },
      { source: "windows", target: "application" },
      { source: "windows", target: "pcvr" },
      { source: "pcvr", target: "openxr", lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.32, curveness: -0.5 } },
      ...
      { source: "sf-template", target: "xra" },
      {
        source: "sf-library",
        target: "sf-standard",
        lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.32, curveness: 0.25 },
      },
      {
        source: "ctp",
        target: "sf-library",
        lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.32, curveness: -0.3 },
      },
      {
        source: "pmtp",
        target: "sf-library",
        lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.32, curveness: 0.35 },
      },
      {
        source: "xra",
        target: "sf-library",
        lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.32, curveness: 0.15 },
      },
      {
        source: "ctp",
        target: "sf-standard",
        lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.32, curveness: 0.28 },
      },
      {
        source: "pmtp",
        target: "sf-standard",
      ...
      },
      {
        source: "xra",
        target: "sf-standard",
        lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.32, curveness: 0.18 },
      },
      {
        source: "sf-one-off",
        target: "sf-library",
        lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.32, curveness: -0.2 },
      },
      {
        source: "sf-one-off",
        target: "sf-standard",
      ...
      },
      {
        source: "webcam",
        target: "opencv",
        lineStyle: { type: "dashed", color: "#d8d8d8", opacity: 0.32, curveness: 0.4 },
      },
      {
        source: "tp-sdk",
        target: "application",
        lineStyle: { color: "#d0d0d0", type: "dashed", width: 1.5, opacity: 0.32, curveness: -0.35 },
      },
      {
        source: "tp-plugin",
        target: "application",
        lineStyle: { color: "#d0d0d0", type: "dashed", width: 1.5, opacity: 0.32, curveness: -0.45 },
      },
    ],
  };
