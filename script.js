...
(function () {
  ...
  const DEV_ENV_GRAPH = {
    ...
    links: [
      ...
      { source: "meta-quest", target: "openxr", lineStyle: { type: "dashed", color: "#cccccc", opacity: 0.45, curveness: 0.45 } },
      { source: "pico", target: "openxr", lineStyle: { type: "dashed", color: "#cccccc", opacity: 0.45, curveness: 0.2 } },
      { source: "htc", target: "openxr", lineStyle: { type: "dashed", color: "#cccccc", opacity: 0.45, curveness: -0.35 } },
      { source: "android", target: "api-std" },
      { source: "api-std", target: "openxr" },
      { source: "windows", target: "application" },
      { source: "windows", target: "pcvr" },
      { source: "pcvr", target: "openxr", lineStyle: { type: "dashed", color: "#cccccc", opacity: 0.45, curveness: -0.5 } },
